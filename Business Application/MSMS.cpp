...
void viewcategories();           // view all the categores
/*File Handling*/
...
void viewBudget()
{
    cout << "\t\t\t\t\t\t BUDGET MENU" << endl
         << endl;
    cout << "\n Your Previous Budget is : " << C_Budget[customer] << "Rs.\n";
}
void addtoCart(int option)
{
    if (option == 1)
    {
        ...
        if (cartint)
        {
            ...
            if ((price_Mobiles[cart] > C_Budget[customer])||(stock_Mobiles[cart]<1))
            {
    ...
    else if (option == 2)
    {
        ...
        {
            cart = stoi(input);
            if ((price_Covers[cart] > C_Budget[customer])||(stock_Covers[cart]<1))
            {
                cout << " Out of budget!!!" << endl;
            }
            else
    ...
    else if (option == 3)
    {
        ...
        {
            cart = stoi(input);
            if ((price_Adopters[cart] > C_Budget[customer])||(stock_Adopters[cart]<1))
            {
                cout << " Out of budget or out of stock!!!" << endl;
            }
            else
            {
    ...
    else if (option == 4)
    {
        ...
        {
            cart = stoi(input);
            if ((price_Cables[cart] > C_Budget[customer])||(stock_Cables[cart]<1))
            {
                cout << " Out of budget!!!" << endl;
            }
            else
    ...
    else if (option == 5)
    {
        ...
        {
            cart = stoi(input);
            if ((price_USB[cart] > C_Budget[customer])||(stock_USB[cart]<1))
            {
                cout << " Out of budget!!!" << endl;
            }
            else
    ...
    else if (option == 6)
    {
        ...
        if (cartint)
        {
            cart = stoi(input);
                    cart = cart - 1;
            if ((price_Headphones[cart] > C_Budget[customer])||(stock_Headphones[cart]<1))
            {
                cout << " Out of budget or out  of stock!!!" << endl;
            }
            else
    ...
    else if (option == 7)
    {
        ...
        if (cartint)
        {
            cart = stoi(input);
            cart = cart - 1;
            if ((price_Powerbank[cart] > C_Budget[customer])||stock_Powerbank[cart]<1)
            {
                cout << " Out of budget!!!" << endl;
            }
            else
